...
# Ensure the config object is available for sqlalchemy.url
# This is typically handled by Alembic's run_migrations_offline/online functions
# which use config.get_main_option("sqlalchemy.url")
